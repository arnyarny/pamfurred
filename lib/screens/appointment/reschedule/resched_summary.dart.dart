...
class ReschedAppointmentSummaryScreen extends ConsumerStatefulWidget {
  const ReschedAppointmentSummaryScreen({super.key});

  @override
  ConsumerState<ReschedAppointmentSummaryScreen> createState() =>
      ReschedAppointmentSummaryScreenState();
}

class ReschedAppointmentSummaryScreenState
    extends ConsumerState<ReschedAppointmentSummaryScreen> {
